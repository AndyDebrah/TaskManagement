...
• Controlled permissions: o Admins can manage users, projects, tasks, and reports
...
.java to generate:  Project IDs → PJ001, PJ002, ...

• java to generate: Task IDs → TK001, TK002, ... 
...
• Fail-safe input handling • Reusable UI components via ConsoleMenu
