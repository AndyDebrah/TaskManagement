...
public final class FunctionalUtils {
  ...
  public static Function<Task, String> toTaskId() {
    return t -> t == null ? null : t.getTaskId();
  }

  public static Function<Task, String> toTaskName() {
    return t -> t == null ? null : t.getTaskName();
  }

  public static Function<Task, String> toAssignee() {
    return t -> t == null ? null : t.getAssignedTo();
  }

  public static Function<Task, String> toPriority() {
    return t -> t == null ? null : t.getPriority();
  }

  public static Function<Task, String> toStatus() {
    return t -> t == null ? null : t.getStatus();
  }

  public static Function<Task, String> toDueDate() {
    return t -> t == null ? null : t.getDueDate();
  }

  public static Function<Project, String> toProjectId() {
    return p -> p == null ? null : p.getProjectId();
  }

  public static Function<Project, String> toProjectName() {
    return p -> p == null ? null : p.getProjectName();
  }

  public static ToDoubleFunction<Project> toCompletion() {
    return p -> p == null ? 0.0 : p.calculateCompletionPercentage();
  }
  ...
  /**
   * Compare tasks by priority: High > Medium > Low > (others/null). Then by name
   * ASC.
   */
